...
reg   [31:0] start_y_read_reg_354;
reg   [31:0] start_x_read_reg_359;
wire   [31:0] add_ln25_fu_180_p2;
reg   [31:0] add_ln25_reg_364;
wire   [31:0] add_ln25_1_fu_186_p2;
reg   [31:0] add_ln25_1_reg_369;
wire   [8:0] i_fu_207_p2;
reg   [8:0] i_reg_377;
wire    ap_CS_fsm_state2;
wire    regslice_both_m_axis_video_V_data_V_U_apdone_blk;
wire   [0:0] and_ln25_1_fu_229_p2;
reg   [0:0] and_ln25_1_reg_382;
wire   [0:0] icmp_ln20_fu_201_p2;
wire   [9:0] j_fu_245_p2;
reg   [9:0] j_reg_390;
wire    ap_CS_fsm_state3;
wire   [0:0] and_ln25_2_fu_276_p2;
reg   [0:0] and_ln25_2_reg_395;
wire   [0:0] icmp_ln22_fu_239_p2;
reg   [8:0] i_0_reg_158;
reg   [9:0] j_0_reg_169;
wire  signed [63:0] sext_ln26_fu_281_p1;
reg   [31:0] pixel_1_fu_86;
wire   [31:0] pixel_2_fu_292_p3;
wire   [31:0] zext_ln20_fu_197_p1;
wire   [0:0] icmp_ln25_fu_213_p2;
wire   [0:0] xor_ln25_fu_218_p2;
wire   [0:0] icmp_ln25_1_fu_224_p2;
wire   [31:0] zext_ln22_fu_235_p1;
wire   [0:0] icmp_ln25_2_fu_254_p2;
wire   [0:0] xor_ln25_1_fu_259_p2;
wire   [0:0] icmp_ln25_3_fu_265_p2;
wire   [0:0] and_ln25_fu_270_p2;
wire  signed [31:0] sext_ln26_fu_281_p0;
wire  signed [31:0] pixel_fu_286_p0;
wire   [31:0] pixel_fu_286_p2;
wire  signed [31:0] pixel_2_fu_292_p2;
reg   [4:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln22_fu_239_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln20_fu_201_p2 == 1'd0) & (regslice_both_m_axis_video_V_data_V_U_apdone_blk == 1'b0))) begin
        j_0_reg_169 <= 10'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln22_fu_239_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln20_fu_201_p2 == 1'd1) & (regslice_both_m_axis_video_V_data_V_U_apdone_blk == 1'b0))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln20_fu_201_p2 == 1'd1) & (regslice_both_m_axis_video_V_data_V_U_apdone_blk == 1'b0))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln20_fu_201_p2 == 1'd0) & (regslice_both_m_axis_video_V_data_V_U_apdone_blk == 1'b0))) begin
...
assign add_ln25_1_fu_186_p2 = (start_y + 32'd69);

assign add_ln25_fu_180_p2 = (start_x + 32'd148);

assign and_ln25_1_fu_229_p2 = (xor_ln25_fu_218_p2 & icmp_ln25_1_fu_224_p2);

assign and_ln25_2_fu_276_p2 = (and_ln25_fu_270_p2 & and_ln25_1_reg_382);

assign and_ln25_fu_270_p2 = (xor_ln25_1_fu_259_p2 & icmp_ln25_3_fu_265_p2);
...
assign icmp_ln20_fu_201_p2 = ((i_0_reg_158 == 9'd480) ? 1'b1 : 1'b0);

assign icmp_ln22_fu_239_p2 = ((j_0_reg_169 == 10'd640) ? 1'b1 : 1'b0);

assign icmp_ln25_1_fu_224_p2 = (($signed(zext_ln20_fu_197_p1) < $signed(add_ln25_1_reg_369)) ? 1'b1 : 1'b0);

assign icmp_ln25_2_fu_254_p2 = (($signed(zext_ln22_fu_235_p1) < $signed(start_x_read_reg_359)) ? 1'b1 : 1'b0);

assign icmp_ln25_3_fu_265_p2 = (($signed(zext_ln22_fu_235_p1) < $signed(add_ln25_reg_364)) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_213_p2 = (($signed(zext_ln20_fu_197_p1) < $signed(start_y_read_reg_354)) ? 1'b1 : 1'b0);

assign im_incrust_V_address0 = sext_ln26_fu_281_p1;

assign j_fu_245_p2 = (j_0_reg_169 + 10'd1);

assign m_axis_video_TDATA_int = ((and_ln25_2_reg_395[0:0] === 1'b1) ? im_incrust_V_q0 : s_axis_video_TDATA_int);

assign m_axis_video_TVALID = regslice_both_m_axis_video_V_data_V_U_vld_out;

assign pixel_2_fu_292_p2 = pixel_1_fu_86;

assign pixel_2_fu_292_p3 = ((and_ln25_2_fu_276_p2[0:0] === 1'b1) ? pixel_fu_286_p2 : pixel_2_fu_292_p2);

assign pixel_fu_286_p0 = pixel_1_fu_86;

assign pixel_fu_286_p2 = ($signed(pixel_fu_286_p0) + $signed(32'd1));

assign sext_ln26_fu_281_p0 = pixel_1_fu_86;

assign sext_ln26_fu_281_p1 = sext_ln26_fu_281_p0;

assign xor_ln25_1_fu_259_p2 = (icmp_ln25_2_fu_254_p2 ^ 1'd1);

assign xor_ln25_fu_218_p2 = (icmp_ln25_fu_213_p2 ^ 1'd1);

assign zext_ln20_fu_197_p1 = i_0_reg_158;

assign zext_ln22_fu_235_p1 = j_0_reg_169;
